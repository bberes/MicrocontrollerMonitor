#pragma once
#ifndef Communication__HiTerm_Command_ReadUnits__hpp
#define Communication__HiTerm_Command_ReadUnits__hpp
...
class COMMUNICATION_EXPORT ReadUnits::Command final : public Message::CommandBase {
public:
...
class COMMUNICATION_EXPORT ReadUnits::Response final : public Message::ResponseBase {
public:
	explicit Response (DeserializationSelector);
	explicit Response (UInt8 key, const ByteArray& units);
